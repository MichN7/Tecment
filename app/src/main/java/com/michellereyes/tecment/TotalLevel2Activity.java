...
public class TotalLevel2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(numberCorrectAnswers != null){
            ...
            ref.child(user.getUid()).child("nivelDos/Calificacion").setValue(String.valueOf(grade));
            ref.child(user.getUid()).child("nivelDos/RespuestasCorrectas").setValue(numberCorrectAnswers);
            ref.child(user.getUid()).child("nivelDos/hecho").setValue("true");
            ...
            String Calificacion = pref.getString("nivelDosCal",null);
            String RespuestasCorrectas = pref.getString("nivelDosRes",null);
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TotalLevel2Activity.this, LevelsActivity.class));
            }
        });
